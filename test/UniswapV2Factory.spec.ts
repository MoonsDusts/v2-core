...
describe('UniswapV2Factory', () => {
  ...
  async function createPair(tokens: [string, string]) {
    const bytecode = `0x${RCPswapV2Pair.evm.bytecode.object}`
    ...
    const pair = new Contract(create2Address, JSON.stringify(RCPswapV2Pair.abi), provider)
  ...
  it('createPair:gas', async () => {
    ...
    expect(receipt.gasUsed).to.eq(2471809)
  })
